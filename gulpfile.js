...
gulp.task("server", function () {
   ...
   if (checkFilesPresense('./src', '.pug')) gulp.watch("./src/*.pug", gulp.series("pug"));
   if (fse.existsSync("./src/pug")) gulp.watch("./src/pug/**/*.pug", gulp.series("pug"));

});

// DEFAULT
gulp.task("default",
   gulp.series("cleardist", "copyfiles", "scss", "pug", "server")
);
